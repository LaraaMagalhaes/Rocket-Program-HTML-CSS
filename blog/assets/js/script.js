...
// const headerButtonEl = document.querySelector('#header button');
// const paragraphsEl = document.querySelector('.post p');

// console.dir(menuEl);
// console.log(linksEls)
// console.log(postsEls)
// console.dir(headerButtonEl);
...
},
{
    ...
    <p>
          ...
          <ul>
            <li><span>&lt;p&gt;</span>: Tag de abertura</li>
            <li><span>&lt;/p&gt;</span>: Tag de fechamento</li>
...
.texto { 
  color: blue; 
  font-size: 20px; 
 }</pre> <!--essa tag faz com q a formatação continue a mesma, independente -->
          <h3>Principais propriedades:</h3>
          <ul>
            <li>Cores e fontes:</li>
            <ul>
              <li><span>color</span>: Cor do texto.</li>
              <li>
                <span>background-color</span>: Cor de fundo.
              </li>
              <li><span>font-size</span>: Tamanho da fonte.</li>
              <li><span>font-family</span>: Tipo da fonte.</li>
            </ul>
            <li>Espaçamento:</li>
            <ul>
              <li>
                <span>margin</span>: Espaço externo (fora do
                elemento).
              </li>
              <li>
                <span>padding</span>: Espaço interno (dentro do
                elemento).
              </li>
            </ul>
            ...
            <ul>
              <li>
                <span>display</span>: Define como o elemento é
                exibido (ex.: block, inline, flex).
              </li>
              <li>
                <span>position</span>: Define a posição (ex.:
                relative, absolute).
              </li>
              <li>
                <span>width e height</span>: Largura e altura.
              </li>
            </ul>
          </ul>
